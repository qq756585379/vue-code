...
export const getSelectedProductList = (params) => new Http().require({
	api: '/api/shop/GetSelectedProductList',
	param: params
}); //获取购物车列表
...
export const removeSelectedProduct = (params) => new Http().require({
	api: '/api/shop/RemoveSelectedProduct',
	param: params
}); //获取

export const confirmSelectProduct = (params) => new Http().require({
	api: '/api/shop/ConfirmSelectProduct',
	param: params
}); //获取

export const getConfirmSelectedProductList = (params) => new Http().require({
	api: '/api/shop/GetConfirmSelectedProductList',
	param: params
}); //获取
...
export const getGoodsCategoryList = (params) => new Http().require({
	api: '/api/cms/GetGoodsCategoryList',
	param: params
}); //获取咨询分类列表
