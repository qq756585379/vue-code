...
const cms = {
	...
	actions: {
		GetIndexCmsData({commit, state}, parameterData) {
		...
		GetArticle({commit, state}, parameterData) {
			return new Promise((resolve, reject) => {
		...
		GetArticleList({commit, state}, parameterData) {
			return new Promise((resolve, reject) => {
		...
		GetGoodsCategoryList({commit, state}, parameterData) {
			return new Promise((resolve, reject) => {
		...
		GetRecommend({commit, state}, parameterData) {
			return new Promise((resolve, reject) => {
